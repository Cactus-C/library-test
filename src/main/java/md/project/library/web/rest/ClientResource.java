...
import md.project.library.repository.ClientRepository;
import md.project.library.service.ClientService;
...
/**
 * REST controller for managing {@link md.project.library.domain.Client}.
 */
@RestController
