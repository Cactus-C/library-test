...
import md.project.library.repository.AuthorRepository;
import md.project.library.service.AuthorService;
...
/**
 * REST controller for managing {@link md.project.library.domain.Author}.
 */
@RestController
