...
import static md.project.library.domain.BookAsserts.*;
...
import md.project.library.service.BookService;
import md.project.library.service.dto.BookDTO;
import md.project.library.service.mapper.BookMapper;
...
class BookResourceIT {
    ...
    void partialUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.isbn(UPDATED_ISBN).name(UPDATED_NAME).picture(UPDATED_PICTURE);
